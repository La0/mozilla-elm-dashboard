...
var _La0$mozilla_dashboard$Main$viewBug = function (bug) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('bug')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(bug.summary)
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'#',
									_elm_lang$core$Basics$toString(bug.bugzilla_id)))
							])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('View on bugzilla')
							]))
					])),
				A2(
...
var _La0$mozilla_dashboard$Main$view = function (analysis) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Analysis: ', analysis.name))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, _La0$mozilla_dashboard$Main$viewBug, analysis.bugs))
			]));
};
var _La0$mozilla_dashboard$Main$subscriptions = function (analysis) {
	return _elm_lang$core$Platform_Sub$none;
};
var _La0$mozilla_dashboard$Main$Bug = F3(
	function (a, b, c) {
		return {id: a, bugzilla_id: b, summary: c};
	});
var _La0$mozilla_dashboard$Main$decodeBug = A4(
	_elm_lang$core$Json_Decode$object3,
	_La0$mozilla_dashboard$Main$Bug,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'bugzilla_id', _elm_lang$core$Json_Decode$int),
	A2(
		_elm_lang$core$Json_Decode$at,
		_elm_lang$core$Native_List.fromArray(
			['payload', 'bug', 'summary']),
		_elm_lang$core$Json_Decode$string));
var _La0$mozilla_dashboard$Main$Analysis = F3(
	function (a, b, c) {
		return {id: a, name: b, bugs: c};
	});
var _La0$mozilla_dashboard$Main$decodeAnalysis = A4(
	_elm_lang$core$Json_Decode$object3,
	_La0$mozilla_dashboard$Main$Analysis,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'bugs',
		_elm_lang$core$Json_Decode$list(_La0$mozilla_dashboard$Main$decodeBug)));
var _La0$mozilla_dashboard$Main$FetchAnalysisFailure = function (a) {
	return {ctor: 'FetchAnalysisFailure', _0: a};
};
var _La0$mozilla_dashboard$Main$FetchAnalysisSuccess = function (a) {
	return {ctor: 'FetchAnalysisSuccess', _0: a};
};
var _La0$mozilla_dashboard$Main$fetchAnalysis = function (id) {
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
	...
	return A3(
		...
		_La0$mozilla_dashboard$Main$FetchAnalysisFailure,
		_La0$mozilla_dashboard$Main$FetchAnalysisSuccess,
		A2(_evancz$elm_http$Http$get, _La0$mozilla_dashboard$Main$decodeAnalysis, url));
};
var _La0$mozilla_dashboard$Main$init = function (analysis_id) {
	return {
		ctor: '_Tuple2',
		_0: A3(
			_La0$mozilla_dashboard$Main$Analysis,
			...
			_elm_lang$core$Native_List.fromArray(
				[])),
		_1: _La0$mozilla_dashboard$Main$fetchAnalysis(analysis_id)
	};
};
var _La0$mozilla_dashboard$Main$update = F2(
	function (msg, analysis) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'FetchAnalysis':
				return {
					ctor: '_Tuple2',
					_0: analysis,
					_1: _La0$mozilla_dashboard$Main$fetchAnalysis(_p0._0)
				};
			case 'FetchAnalysisSuccess':
				return {ctor: '_Tuple2', _0: _p0._0, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				return {ctor: '_Tuple2', _0: analysis, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _La0$mozilla_dashboard$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _La0$mozilla_dashboard$Main$init(1),
			view: _La0$mozilla_dashboard$Main$view,
			update: _La0$mozilla_dashboard$Main$update,
			subscriptions: _La0$mozilla_dashboard$Main$subscriptions
		})
};
var _La0$mozilla_dashboard$Main$FetchAnalysis = function (a) {
	return {ctor: 'FetchAnalysis', _0: a};
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _La0$mozilla_dashboard$Main$main === 'undefined' ? null : _La0$mozilla_dashboard$Main$main);
